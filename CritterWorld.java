...
public class CritterWorld extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("src/assignment5/song1.wav").getAbsoluteFile());
		Clip clip = AudioSystem.getClip();
		clip.open(audioInputStream);
		
		world.setMinSize(Params.world_width , Params.world_height);
		world.setMaxSize(Params.world_width*10, Params.world_height*10);
